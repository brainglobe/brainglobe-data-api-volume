Full metadata details from the openminds fields we are starting with are in [./promising-openminds-metadata.md](./promising-openminds-metadata.md). 

They are:
* measured_quantity - What the voxel values in a 3D volume actually represent.
* biological_sex - Differentiation of individuals of most species (animals and plants) based on the type of gametes they produce.
* developmental_stage - Distinct life cycle class that is defined by a similar age or age range (developmental stage) within a group of individual beings.
